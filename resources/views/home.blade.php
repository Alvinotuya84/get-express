      ...
      <div class="col hp">
        <div class="card h-100 shadow-sm">
          ...
          <div class="label-top shadow-sm">
            <a class="text-white" href="{{route('productDetails',['id'=>$product->id])}}">{{$product->name}}</a>
          </div>
          <div class="card-body">
            <div class="clearfix mb-3">
              <span class="float-start badge rounded-pill bg-success">Ksh:{{$product->price}}</span>
            ...
            <div class="d-grid gap-2 my-4">
              ...
              <a href="{{route('productDetails',['id'=>$product->id])}}" class="btn btn-warning bold-btn">Product Details</a>
